...
**Note:** *There is an updated version of the project root in branch [mean-clean-v3](https://github.com/chriskmnds/mean-clean/tree/mean-clean-v3) (also in [PR](https://github.com/chriskmnds/mean-clean/pull/2)) with slightly improved overall setup and a more functional frontend (serving beyond SPA).*
